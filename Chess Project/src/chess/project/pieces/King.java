...
public class King extends Piece {
    ...
    /**
     * determines all valid moves of this King and saves them in the validMoves
     * List
     *
...
// checks if the king is able to casle by its boolean variable and position on the board
     ...
     * @return true once a piece is found that may take the king false if all
     * threatening spaces have been checked and there are no threats to the king
     */
...
//                            Knight Movement
    ...
    @Override
    public Piece clone() {
        return new King(colour, position, validMoves, castlable);
    }
}

...
public abstract class Piece implements Serializable {
     ...
     *
     * @return the ChessColour associated with the piece (ie 'BLACK' or 'WHITE')
     */
    ...
    /**
     * adds a move to the validMoves list if it will not put it's allied King in
     * check
     *
     * @param board an array containing all pieces and information regarding
     * turns
    ...
    /**
     * Evaluates all positions on the board that are diagonal to this piece. If
     * the position in question is within the bounds of the board, not an allied
     * piece and will not put the allied King in check, the move will be added
     * to a list of valid moves
     *
    ...
    protected void verticalMovement(Board board) {
        ...
        // next is the change that will
        // take place in the position being evaluated
    ...
    /**
     * Evaluates all positions on the board that are adjacent to this piece If
     * the position in question is within the bounds of the board, not an allied
     * piece and will not put the allied King in check, the move will be added
     * to a list of valid moves
     *
